...
import com.example.lab9.api.ApiClient.apiService
import com.example.lab9.api.ApiFetcher
import com.example.lab9.data.MovieDatabase
import com.example.lab9.databinding.ActivityAddMovieBinding
...
import com.example.lab9.viewmodel.MovieViewModel
import com.example.lab9.viewmodel.MovieViewModelFactory
...
class AddMovieActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getMovieLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == RESULT_OK) {
                movie = result.data?.getParcelableExtra("movie")
            }
        }
    ...
    private fun getYearsList(): List<String> {
        ...
        return listOf("Any") + (1900..currentYear).map { it.toString() }.reversed() // Возвращаем список годов
    }
